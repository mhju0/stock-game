...
v1.0.2 is the current maintenance release. v1.1.0 is the approved showcase-interface release candidate and does not change product scope, trading rules, auth, or data ownership. See [PROJECT_STATUS.md](PROJECT_STATUS.md) for the verified deployment, test, security, GitHub, and deliberately open decision snapshot.

## Accepted maintenance

- Security patches and credential-independent hardening.
- Dependency vulnerability and production compatibility updates.
- Fixes for regressions against the documented v1.0 behavior.
- Deployment, CI, keepalive, and demo availability repairs.
- Documentation and screenshot corrections.

## Out of scope by default

- New product features or another UI redesign.
- Leaderboards, global ranking, or social competition.
- Schema migrations or changes to session ownership and trading rules without a separately approved project phase.
