...
| Test inventory | `[Verified]` 275 backend tests, 36 frontend unit/config tests, and 5 rendered Chromium flows pass on the current maintenance tree. |
...
The 2026-09-02 repository truth audit also reconciled the public README,
...
The v1.1.0 release and the 2026-09-02 maintenance audit use these
