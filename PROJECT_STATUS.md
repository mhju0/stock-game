...
| Interface verification | `[Verified]` Fixed-fixture captures were regenerated and directly reviewed at 1440px, 1280px, and a 390x844 mobile viewport in dark and light themes. Playwright verifies chart capture stability, keyboard dialog containment, route navigation, 375px overflow, and reduced motion. `[Unknown]` An in-app browser session was unavailable during the current audit, so no additional live-browser visual claim is made. |
...
| Test inventory | `[Verified]` 275 backend tests, 26 frontend unit/config tests, and 5 rendered Chromium flows pass on the current maintenance tree. |
...
The 2026-09-01 repository truth audit also reconciled the public README,
...
The v1.1.0 release and the 2026-09-01 maintenance audit use these
